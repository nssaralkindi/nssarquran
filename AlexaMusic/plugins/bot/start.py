        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/TH3SS) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/39eb219741691a9950d5e.jpg",
        caption=f"""- مرحبا بك عزيزي الكريم في 
┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
- بوت تشغيل القران الكريم في القنوات والمجموعات التابعة لمنصة 
┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
- تليجرام تم انشاء البوت بجهد كبير من اجل هذا المشروع الديني
┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ 
- يدعم ايضا تشغيل الصوت والفيديو مع ميزة البث المباشر ..""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 قناة البوت 💮", url=f"https://t.me/NNINB")]]
        ),
    )
